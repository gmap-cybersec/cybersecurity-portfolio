...
As a cybersecurity analyst in a simulated enterprise environment, I used SQL queries to filter and analyze login attempts and employee records from two tables: log_in_attempts and employees.
...
**🖼️ Screenshots**
-----
(Optional) You can find screenshots of query executions in the screenshots/ folder.
